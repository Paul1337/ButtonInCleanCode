...
(function (root, factory) {
   ...
   *  }
    ...
    fft = function () {
         ...
         *  two types of analyses: <br> вЂў <code>FFT.waveform()</code> computes
         *  amplitude values along the time domain. The array indices correspond
         *  to samples across a brief moment in time. Each value represents
         *  amplitude of the waveform at that sample of time.<br>
         *  вЂў <code>FFT.analyze() </code> computes amplitude values along the
   ...
   *  }
    ...
    env = function () {
         ...
         *  ). Envelopes can also control other Web Audio ParametersвЂ”for example, a p5.Env can
   ...
   *  }
         ...
         *  you may want to include an errorCallbackвЂ”a function that is called in case
   ...
   *  }
    ...
    looper = function () {
         ...
         *  this phrase will call at every stepвЂ”for example it might be
